...
public final class MemoryCounter {
	private static class MemorySizes {
		private final Map<Class<?>, Integer> primitiveSizes = 
			new IdentityHashMap<Class<?>, Integer>();
		
		MemorySizes() {
			primitiveSizes.put(boolean.class, new Integer(1));
			primitiveSizes.put(byte.class, new Integer(1));
			primitiveSizes.put(char.class, new Integer(2));
			primitiveSizes.put(short.class, new Integer(2));
			primitiveSizes.put(int.class, new Integer(4));
			primitiveSizes.put(float.class, new Integer(4));
			primitiveSizes.put(double.class, new Integer(8));
			primitiveSizes.put(long.class, new Integer(8));
		};
