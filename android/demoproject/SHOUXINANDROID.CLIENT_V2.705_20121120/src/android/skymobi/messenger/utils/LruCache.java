...
/**
 * @ClassName: LruCache
 * @Description: An LRU cache which stores recently inserted entries and all
 *               entries ever inserted which still has a strong reference
 *               elsewhere.
 * @author Michael.Pan
 * @date 2012-5-29 下午01:22:29
 */
...
public class LruCache<K, V> {
    ...
    public synchronized int weakSize() {
