...
import android.skymobi.messenger.exception.DbBussException;
...
public class BaseImpl implements BaseDAO {
    ...
    protected SQLiteDatabase getSQLiteDatabase() {
        return MessengerDatabaseHelper.getInstance(this.context).getSQLiteDatabase();
    }
    ...
    protected int getMaxId(final String tableName, final int step) {
        int maxId = 0;
        List<String> list = query("SELECT max(" + ContactsColumns._ID + ") FROM " + tableName,
                new String[0]);
